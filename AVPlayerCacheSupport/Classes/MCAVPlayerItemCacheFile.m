...
#define QW_LOCK(args) dispatch_semaphore_wait(args, DISPATCH_TIME_FOREVER);
#define QW_UNLOCK(args) dispatch_semaphore_signal(args);
...
@interface MCAVPlayerItemCacheFile ()
    {
        ...
        BOOL _compelete;
        dispatch_semaphore_t _cachesLock;
    }
    @end
